...
--
myNormalBorderColor  = "#c2c2c2"
myFocusedBorderColor = "#8505f5"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm,               xK_space ), spawn "rofi -show drun -theme purple")

    -- close focused window
    , ((modm,               xK_apostrophe), kill)

     -- Rotate through the available layout algorithms
    , ((modm,               xK_u), sendMessage NextLayout >> sendMessage ToggleStruts)
    ...
    -- Screenshot
    , ((modm              , xK_x     ), spawn "maim -s | xclip -selection clipboard -t image/png")

    -- launch gdb
    -- , ((modm              , xK_o     ), spawn "kitty -e gdb -ex 'target remote:1337' -x ~/Shared/.gdbscript")
    ...
    -- Launch sublime to edit deathnot3
    , ((modm              , xK_p     ), spawn "subl /home/k1r4/Shared/projects/deathnot3")
...
myLayout = avoidStruts (bsp ||| full)
  where
     ...
     -- emptyBSP with borders
     bsp     =  spacingRaw False (Border 0 i 0 i) True (Border i 0 i 0) True $ emptyBSP
